...
class List extends Component {
  ...
  componentWillReceiveProps(nextProps){
    ...
    if (JSON.stringify(nextProps) !== JSON.stringify(this.props)) {
      this.fetchByTitle(nextProps.searchTitle);
      console.log(nextProps.searchTitle);
    }
  }
  ...
  fetchByTitle(query) {
    ...
    if (!query) {
      ...
      let url = 'https://api.themoviedb.org/3/search/movie?api_key=1a7ed83d36bb05c69c3c11ec64f2fb82&language=en-US&page=1&include_adult=false&query='+query;
      fetch(url)
